...
class renderer extends loadsave{
    protected   $imagesPath = 'images/';
    private     $themeNamePrefix = 'adaptable';
    protected   $tabs = null;
    ...
    protected function header($savePostTo){
        ...
        $PAGE->set_pagelayout('settings');
        $PAGE->set_context(context_system::instance());
        $PAGE->set_title('Settings');
        $PAGE->set_url($CFG->wwwroot."/theme/adaptable/settings/index.php");
        ...
        echo            '<h1>Settings</h1>';
        echo            '<input type="submit" value="Save" style="float:right;"/>';
        echo            '<a href="'.$CFG->wwwroot.'"><input type="button" value="Back" id="backOptions" style="float:right;"/></a>';
    ...
    protected function footer(){
        ...
        foreach( $this->tabs as $key => $value){
            echo '<div class="sidebarTabs'.(( (isset($_GET['lp']) && $_GET['lp'] == $key) || (!isset($_GET['lp']) && $key=='general'))?" tabActive":"").'" id="'.$key.'Tab"><i class="fa fa-2x fa-'.$value->icon.'"></i><h4 style="display: inline; padding-left: 10px;">'.$value->text.'</h4></div>';
        }
        reset($this->tabs);
        ...
        foreach( $this->tabs as $key => $value){
            ...
            echo    '<h2>'.ucwords($value->text.' Settings').'</h2>';
    ...
    protected function listRender($id, $default = null, $options = null, $classes = null, $tab){
        ...
        if((!is_array($items)) || (sizeof($items) == 0)){
            ...
            echo                '<td><div id="editing" class="editingbutton" style="display:none;">Remove</div></td>';
            echo            '</tr>';        
        }else{
            $n = 1;
            ...
            foreach ($items as $k => $v) {
                ...
                echo                '<td><div id="editing" class="editingbutton" '.((sizeof($items)==1)?'style="display:none;"':'').'>Remove</div></td>';
                echo            '</tr>';
            }
        ...
        echo                    '<center>';
        echo                        '<div class="editingbutton">Add</div>';
        echo                    '</center>';
        echo                '</td>';
        echo            '</tr>';
        echo        '</tfoot>';
    ...
    protected function singlelistRender($id, $title, $options = null, $classes = null, $tab){
        ...
        echo                '<td colspan="'.(2+sizeof($options)).'">';
        echo                    '<center>';
        echo                        '<div id="editing" class="editingbutton">Add</div>';
        echo                    '</center>';
        echo                '</td>';
        echo            '</tr>';
        echo        '</tfoot>';
    ...
    protected function slideshowRender($id, $default = null, $options = null, $classes = null, $tab){
        ...
        if((!is_array($items)) || (sizeof($items) == 0)){
            ...
            echo                                    '<div id="editing" class="editingbutton" style="display:none;">Remove</div>';
            echo                                    '<div id="editing" class="editingbutton" style="margin-left:5px;">Maximize</div>';        
            echo                                '</td>';
            echo                            '</tr>';
            echo                        '</tfoot>';
            echo                    '</table>';
            ...
            foreach ($items as $k => $v) {
                ...
                echo                            '<tr>';
                echo                                '<td align="center" colspan="2">';
                echo                                    '<div id="editing" class="editingbutton slideshowRemove" '.((sizeof($items)==1)?'style="display:none;"':'').'>Remove</div>';
                echo                                    '<div id="editing" class="editingbutton slideshowMinimize" style="margin-left:5px;">Maximize</div>';        
                echo                                '</td>';
                echo                            '</tr>';
                echo                        '</tfoot>';
                echo                    '</table>';
        ...
        echo                '<td colspan="2">';
        echo                    '<center>';
        echo                        '<div id="editing" class="editingbutton slideshowAdd">Add</div>';
        echo                    '</center>';
        echo                '</td>';
        echo            '</tr>';
        echo        '</tfoot>';
    ...
    protected function linkboxRender($id, $default = null, $options = null, $classes = null, $tab){
        ...
        if((!is_array($items)) || (sizeof($items) == 0)){
            ...
            echo                                    '<div id="editing" class="editingbutton linkboxRemove" style="display:none;">Remove</div>';
            echo                                    '<div id="editing" class="editingbutton linkboxMinimize" style="margin-left:5px;">Maximize</div>';        
            echo                                '</td>';
            echo                            '</tr>';
            echo                        '</tfoot>';
            echo                    '</table>';
            ...
            foreach ($items as $k => $v) {
                ...
                echo                            '<tr>';
                echo                                '<td align="center" colspan="3">';
                echo                                    '<div id="editing" class="editingbutton linkboxRemove" '.((sizeof($items)==1)?'style="display:none;"':'').'>Remove</div>';
                echo                                    '<div id="editing" class="editingbutton linkboxMinimize" style="margin-left:5px;">Maximize</div>';        
                echo                                '</td>';
                echo                            '</tr>';
                echo                        '</tfoot>';
        ...
        echo                '<td colspan="3">';
        echo                    '<center>';
        echo                        '<div id="editing" class="editingbutton linkboxAdd">Add</div>';
        echo                    '</center>';
        echo                '</td>';
        echo            '</tr>';
        echo        '</tfoot>';
